...
/** Add your docs here. */
public class AutonomousTurnCommand extends FollowPathHolonomic{

    public AutonomousTurnCommand(PathPlannerPath trajectoryPath) {
        super(
            trajectoryPath,
    ...
    public AutonomousTurnCommand(String trajectoryName, double maxVelocity, double maxAngularVelocity) {
        this(
    ...
    public AutonomousTurnCommand(String trajectoryName){
        this(
            PathPlannerPath.fromPathFile(trajectoryName)
        );
    }
