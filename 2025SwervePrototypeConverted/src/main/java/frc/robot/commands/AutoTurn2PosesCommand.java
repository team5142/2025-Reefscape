 ...
 */
public class AutoTurn2PosesCommand extends SequentialCommandGroup {
  /**
   * Run a trajectory between 2 poses with max velocity and acceleration
   * @param startPose
   * @param endPose
   */
  public AutoTurn2PosesCommand( Pose2d startPose, Pose2d endPose) {
   ...
   */
  public AutoTurn2PosesCommand( Pose2d startPose, Pose2d endPose, double maxVelocity, double maxAcceleration) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    ...
    addCommands(
      new RunTrajectoryTurnAtStartPointCommand(
        new PathPlannerPath(
